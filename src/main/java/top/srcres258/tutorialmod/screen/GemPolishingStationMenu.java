...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    public GemPolishingStationMenu(
            int pContainerId,
            Inventory inv,
    ...
    public GemPolishingStationMenu(
        ...
        blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            addSlot(new SlotItemHandler(iItemHandler, 0, 80, 11));
            addSlot(new SlotItemHandler(iItemHandler, 1, 80, 59));
        });
    ...
    public int getScaledProgress() {
        ...
        var maxProgress = data.get(1); // Max progress.
        var progressArrowSize = 26; // This is the height in pixels of our arrow.
